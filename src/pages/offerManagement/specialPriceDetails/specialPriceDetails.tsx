      ...
      <>
        <div>
              ...
              <Controller
                ...
                render={({ field }: any) => (
                  <Dropdown
                    ...
                    setValue={setValue}
                    getValues={getValues}
                    validation={{ required: "termsAndConditions is required" }}
                    ...
                    <ul className="listing-selected-items">
                      {
                        selecteFoodItems.map((item:any,index:number)=>(
                          <li key={index} className= {`${index===highlighted && "highlighted"} selectedlist`} onClick={()=>handleItemClick(index,item)}>{item.itemName}</li>
                ...
                <tbody>
                  {selectedFoodItems?.map((item:any, index) => (
                    <tr key={index} className="offeritems-listed">
                      ...
                      <td className="offer-table-data">{item.originalPrice}</td>
                      <td className="offer-table-data">{item.updatedPrice}</td>
                      <td
          ...
          <div className="saveandcancel-btn-offer">
            ...
            <button className="save-btn" onClick={handleonclick}>Save</button>
          </div>

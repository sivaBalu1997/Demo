  ...
  return (
    <>
      <div className="MenuPage-container">
        <SidePanel />
        <div className="MenuPage-Part">
          <div className="MenuPage-HeaderComponent">
            {" "}
            <Header />
          </div>
          <div className="MenuPage-Listing">
            <div className="table-one-div">
              <table>
                ...
                <tbody ref={tableBodyRef1}>
  {itemList?.map((data, parentIndex) => (
    <React.Fragment key={parentIndex}>
      {/* Render the name */}
      <tr>
        <td colSpan={4} className="item-group-name">
          {data?.name}
        </td>
      </tr>
      {/* Render the items under each name */}

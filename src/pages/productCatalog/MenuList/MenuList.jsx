...
const MenuList = () => {
  ...
  const secondHeaderPRef = useRef(null);
  const tableSpanRef = useRef(null);

  useEffect(() => {
    const setWidth = () => {
      if (secondHeaderPRef.current && tableSpanRef.current) {
        const tableSpanWidth = tableSpanRef.current.offsetWidth;
        secondHeaderPRef.current.style.width = `${tableSpanWidth}px`;
      }
    };
    setWidth();
  ...
  return (
    <div className="menuList">
      ...
      <div className="menuListContainer">
        <div className={`${isExpanded ? "MenuListExpanded" : "MenuListPart"}`}>
          <Header />
        ...
        <div className={isExpanded ? "menuListBodyExpanded" : "menuListBody"}>
          <div className="headerContainer">
            <div className="menuListFirstHeaderSection">
              <p className="menuListHeaderImage">Image</p>
              <p className="menuListHeaderName-item">ItemName</p>
              <p className="menuListHeaderItem-code">
                <span> Code </span>
                <button
                  className="menuListAddbtn-menupage"
                  onClick={() => {
                    if (
                      itemList.length > 0 &&
                      itemList?.some(
            ...
            <div
              ...
              className={`${
                isExpanded
                  ? "menuListHeaderScrollExpanded"
                  : "menuListHeaderScroll"
              }`}
            >
              <div className="scrollContainer">
                <div className="menuListSecondHeaderSection">
                  {!menuDataLoading &&
                    !menuDataFailed &&
                    itemList?.length > 0 &&
                    itemList?.some(
                    ...
                    firstRowTable.map((header, index) => {
                      ...
                      if (
                        header.label === "menuListSecondHeaderCustomize" ||
                        nameOfOrderTypes?.includes(headerName)
                      ) {
                        return (
                          <>
                            {listingobject && listingobject[header.label] && (
                              <p ref={secondHeaderPRef}>
                                <span className="menuListSecondHeaderBorderfor-header">
                                  {header.label !==
                                    "menuListSecondHeaderInventory" &&
                                    header.label !==
                                      "menuListSecondHeaderCustomize" && (
                                      <span className="menuListSecondHeaderDollar">
                                        {header.label.charAt(
                                          header.label.length - 1
                                        ) === "2" ? (
                                  ...
                                  <span className="menuListSecondHeaderSpanheadertext">
                                    {headerName}
                                  </span>
                                  <span
                                    className="menuListSecondHeaderRemoveicon"
                                    onClick={() => {
                                      setlistingobject({
                                        ...listingobject,
                                        [header.label]: false,
                                  ...
                                  >
                                    <img
                                      src={removeicon}
                                      className="menuListSecondHeaderRemoveicon-img"
                                      alt=""
                                      onClick={() =>
                                        setlistingobject({
                                          ...listingobject,
          ...
          >
            <div className="firstBodySection" ref={ref1}>
                          ...
                          (subCategory, index) => (
                            <>
                              {subCategory?.itemResponseList?.length > 0 && (
                                <div className="categoryName-data1">
                                  <p>
                                    {data.categoryName}-{" "}
                    ...
                    <>
                      ...
                      data?.itemResponseList?.length > 0
                        ? data?.itemResponseList?.length > 0 &&
                          data.categoryName !== "" && (
                            <>
                              <div className="categoryName-data2">
                                <p>
                                  {data.categoryName} (
            ...
            <div className="secondBodySection">
              <div
                className={
                  (isExpanded &&
                    !menuDataLoading &&

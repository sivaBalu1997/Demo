...
const SalesOverview: React.FC<ReportProps> = ({ }) => {
  ...
  useEffect(() => {
    Promise.all([
      dispatch(paymentDetailsRequest({ locationid: selectedLocation?.value, tableRecordLimit: 100, tablePageNo: 1, startDate: appliedStartDate, endDate: appliedEndDate })),
      dispatch(salesSummaryReportRequest({ locationid: selectedLocation?.value, tableRecordLimit: 100, tablePageNo: 1, startDate: appliedStartDate, endDate: appliedEndDate })),
      dispatch(staffSalesRequest({ locationid: selectedLocation?.value, tableRecordLimit: 100, tablePageNo: 1, startDate: appliedStartDate, endDate: appliedEndDate })),
      dispatch(salesCardTypeRequest({ locationid: selectedLocation?.value, tableRecordLimit: 100, tablePageNo: 1, startDate: appliedStartDate, endDate: appliedEndDate })),
      dispatch(salesCategoryRequest({ locationid: selectedLocation?.value, tableRecordLimit: 100, tablePageNo: 1, startDate: appliedStartDate, endDate: appliedEndDate })),
      dispatch(salesByChannelRequest({ locationid: selectedLocation?.value, tableRecordLimit: 100, tablePageNo: 1, startDate: appliedStartDate, endDate: appliedEndDate })),
      dispatch(salesByRevenueClassRequest({ locationid: selectedLocation?.value, tableRecordLimit: 100, tablePageNo: 1, startDate: appliedStartDate, endDate: appliedEndDate })),

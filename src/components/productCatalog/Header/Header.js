  ...
  return (
    <div className={isExpanded ? 'Header-Container1' : "Header-Container"}>
      ...
      <div 
        ...
        {/* <img src={plusicon} className='Add-Item-Heading-Plus'  alt="" /> */}


        <span className='Add-Item-Heading-Plus'><svg width="15" height="15" viewBox="0 0 15 15" fill="none" xmlns="http://www.w3.org/2000/svg">

...
interface ErrorStateProps {
  ...
  isDataNotAvailableWithCustomMessage?: boolean;
  customTitle?: string;
...
const ErrorState: React.FC<ErrorStateProps> = ({
  ...
  customTitle = "Report Not Available",
  customMessage = "",
}) => {
  return (
    <>
      ...
      {isError && (
        <div className="rep-page-error-not-available-container">
          <PageErrorIcon />
          <p className="rep-page-error-not-available-content-title">
            Error loading Data
          </p>
      ...
      {isDataNotAvailableWithCustomMessage && (
        <div className="rep-page-error-not-available-container">
          <PageNotAvailableIcon />
          <p className="rep-page-error-not-available-content-title">{`${customTitle}`}</p>
          <span className="rep-page-error-not-available-content-sub">{`${customMessage}`}</span>
        </div>
      )}
    </>
  );

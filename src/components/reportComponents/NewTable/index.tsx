...
const NewTable: React.FC<NewTableProps> = ({
  ...
  // mockTableData.ts (or mockTableData.js)
  ...
  const getDynamicClassNames = (rowvalue: string, headerValue: string) => {
    ...
    } else if (headerValue === "Status" && kpiTitle == "Live Check-ins") {
      if (rowvalue === "In Queue") {
        return "bubble-text-blue-two";
      } else if (rowvalue === "Assigned") {
        return "bubble-text-blue-one ";
      } else if (rowvalue === "Late show") {
        return "bubble-text-brown-one";
      } else if (rowvalue === "Seated") {
        return "bubble-text-light-green-one";
      }
    } else if (headerValue === "Status" && kpiTitle == "Today Check-ins") {
      if (rowvalue === "Late show") {
        return "bubble-text-orange-one ";
      } else if (rowvalue === "Cancelled") {
        return "bubble-text-brown-one";
      } else if (rowvalue === "Completed") {
        return "bubble-text-light-green-one ";
      } else if (rowvalue === "Seated") {
        return "bubble-text-light-green-one";
      }
          ...
          <ReactPaginate
            previousLabel={
              <span className="pagination-label">
                <ArrowLeft className="arrow-icon" /> Prev
              </span>
            }
            nextLabel={
              <span className="pagination-label">
                Next <ArrowRight className="arrow-icon" />
              </span>
            }
            breakLabel="..."

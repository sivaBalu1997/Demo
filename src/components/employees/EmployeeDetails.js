    ...
    <div className='employeeDetails'>
      ...
      {showDropDown && <div className='dropDown'>
        <div className='actionTab'>
          <img src={edit} style={{filter: "brightness(0) saturate(100%) invert(45%) sepia(22%) saturate(1556%) hue-rotate(49deg) brightness(94%) contrast(93%)"}}/>
          <p>Edit</p>
        </div>
        <div className='actionTab'>
        ...
        <div className='detailContainer'>
            <div>
                <div className='title'><p className='tag'>Full Name</p><p className='value'> : {data.name}</p></div>
                <div className='title'><p className='tag'>Assigned Role</p><p className='value'> : {data.role}</p></div>
                <div className='title'><p className='tag'>Assigned Outlet</p><p className='value'> : {data.outlet}</p></div>
            ...
            <div>
                ...
                <div className='title'><p className='tag'>Phone</p><p className='value'> : {data.contact}</p></div>
                <div className='title'><p className='tag'>Address</p><p className='value'> : {data.address}</p></div>
                <div className='title'><p className='tag'>Date of Birth</p><p className='value'> : {data.dob}</p></div>

...
export const MEALTYPE_REQUEST = "MEALTYPE_REQUEST";
export const MEALTYPE_SUCCESS = "MEALTYPE_SUCCESS";
export const MEALTYPE_FAILURE = "MEALTYPE_FAILURE";
...
export const SELECTED_SUBCATEGORY_DATA_REQUEST=" SELECTED_SUBCATEGORY_DATA_REQUEST"

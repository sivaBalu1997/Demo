...
export const  SP_OFFER_LIST_REQUEST="SP_OFFER_LIST_REQUEST";
export const  SP_OFFER_LIST_SUCCESS="SP_OFFER_LIST_SUCCESS";
export const  SP_OFFER_LIST_FAILED="SP_OFFER_LIST_FAILED";

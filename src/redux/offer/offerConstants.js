...
export const CREATE_SPECIAL_OFFER_REQUEST = "SUB_CATEGORY_FETCHDROPDOWN_REQUES";
export const CREATE_SPECIAL_OFFER_SUCCESS = "SUB_CATEGORY_FETCHDROPDOWN_SUCCESS";
export const CREATE_SPECIAL_OFFER_FAILURE = "SUB_CATEGORY_FETCHDROPDOWN_FAILURE";
